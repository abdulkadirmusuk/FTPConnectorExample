...
{
    public class SFTPConnector : IFileAdapter
    {
        private const string SOCKS5_PROXY_METHOD = "2";
        private const string HTTP_PROXY_METHOD = "3";
        private readonly ConnectionInfo connectionInfo;

        public SFTPConnector(ConnectionInfo connectionInfo)
        {
            this.connectionInfo = connectionInfo;
        }

        /// <summary>
        /// Connect SFTP server with connection info
        /// </summary>
        /// <returns></returns>
        public string Connect()
        {
            try
            {
                ...
                SessionOptions sessionOptions = new SessionOptions
                {
                    ...
                    SshHostKeyFingerprint = connectionInfo.SshKey
                };
